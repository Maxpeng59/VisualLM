  ...
  async function runSceneWithRepair(scene, prompt) {
    ...
    for (let attempt = 0; attempt <= MAX_REPAIRS; attempt++) {
      ...
      try {
        ...
        } else if (current.browser_help) {
          // BROWSER EDITION: no AI generator here — a friendly help card.
          setConfidence(
            "Browser edition • free-form AI generation runs in the desktop app — " +
              "try a formula, a reaction, or a curriculum topic",
            "pending",
          );
